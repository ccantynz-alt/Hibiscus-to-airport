...
const SnellsBeachAirportShuttle = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageMeta
        title="Snells Beach to Auckland Airport Shuttle"
        description="Airport shuttle from Snells Beach and Algies Bay to Auckland Airport. Reliable coastal community transfers. Book online 24/7."
        path="/snells-beach-airport-shuttle"
      />
      <Header />
